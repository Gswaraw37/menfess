...
<div class="card">
  ...
  <form method="POST">
    <div class="field">
      ...
      <input autocomplete="off" id="username" placeholder="Username" class="input-field" name="username" type="username">
    </div>
    <div class="field">
      <svg class="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
    ...
    <button class="btn" type="submit" name="login"><?php login()?>Login</button>
  </form>
</div>
